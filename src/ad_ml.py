...
DAT_P1_AD = 0xA90130 + base_ad  # 1Pデータ開始位置
...
ATK_P1_AD = DAT_P1_AD + 0x6B8
ATK_P2_AD = ATK_P1_AD + PLR_STRUCT_SIZE

MOTION_TYPE_P1_AD = DAT_P1_AD + 0x1C
